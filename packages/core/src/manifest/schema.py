...
MANIFEST_CATALOG: dict[str, BlockMapping] = {
    ...
    "mixing": {
        ...
        "stem_ambient_trim_db": ("config", "stem_ambient_trim_db"),
        "stem_height_texture": ("config", "stem_height_texture"),
        "stem_ambient_height_cutoff_hz": ("config", "stem_ambient_height_cutoff_hz"),
        ...
        "stem_movement":  ("config", "stem_movement"),
        "stem_movement_tuning": ("config", "stem_movement_tuning"),
...
_FIELD_MAP: dict[str, tuple[str, type]] = {
    ...
    "stem_ambient_trim_db":         ("stem_ambient_trim_db", dict),
    "stem_height_texture":          ("stem_height_texture", dict),
    "stem_ambient_height_cutoff_hz": ("stem_ambient_height_cutoff_hz", dict),
    ...
    "stem_movement":               ("stem_movement",    dict),
    "stem_movement_tuning":        ("stem_movement_tuning", dict),
