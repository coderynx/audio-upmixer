...
from upmixer_web.shared.manifests import normalize_job_manifest, remove_legacy_native_rate
...
def normalize_track_layout_block(
    ...
    remove_legacy_native_rate(block)
...
def preparation_manifest(
    ...
    remove_legacy_native_rate(updated)
