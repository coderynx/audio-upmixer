          ...
          {stereoLayout
            ...
            : <div className="relative h-full">
              {viewState.spatialView === "scene"
                ? <SceneView channels={channels} routing={routing} placements={trackManifest?.mixing.stem_placement} objectModes={trackManifest?.mixing.stem_object_mode} objectStems={objectStems} selectedStem={selectedStem} colors={stemColors} channelCounts={stemChannelCounts} stemSpectrum={preview.stemSpectrum} channelLevels={preview.channelLevels} speakerEnabled={preview.speakerEnabled} speakerSolo={preview.speakerSolo} onToggleSpeaker={preview.toggleSpeaker} onSoloSpeaker={preview.soloSpeaker} active={preview.playing} intensity={viewState.hazeIntensity} onIntensity={onHazeIntensity} movementSchedule={preview.movementSchedule} playhead={preview.currentTimeRef} playheadTime={preview.currentTime} className="h-full w-full" />
                : viewState.spatialView === "elevation"
                  ? <ElevationView channels={channels} routing={routing} selectedStem={selectedStem} colors={stemColors} channelCounts={stemChannelCounts} stemSpectrum={preview.stemSpectrum} speakerEnabled={preview.speakerEnabled} speakerSolo={preview.speakerSolo} onToggleSpeaker={preview.toggleSpeaker} onSoloSpeaker={preview.soloSpeaker} active={preview.playing} intensity={viewState.elevationIntensity} onIntensity={onElevationIntensity} movementSchedule={preview.movementSchedule} playhead={preview.currentTimeRef} playheadTime={preview.currentTime} className="h-full w-full" />
