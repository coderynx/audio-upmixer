...
export const TEST_SERVED_CONSTANTS: ServedEngineConstants = {
  ...
  movement: {
    ...
    tuning: {
      ...
      activity_enter_db: 6,
      activity_leave_db: 3,
      activity_dwell_ms: 80,
      activity_exit_dwell_ms: 250,
      focus_prominence_db: 6,
      focus_share: .85,
      focus_qualification_ms: 750,
      focus_attack_ms: 750,
      focus_release_ms: 1500,
      vocal_hold_ms: 1200,
      winner_hold_ms: 1000,
      challenger_db: 3,
      supporting_span_db: 24,
      percussion_rise_db: 6,
      percussion_gate_db: 6,
      percussion_retrigger_ms: 120,
      percussion_attack_ms: 40,
      percussion_return_ms: 300,
      toms_return_ms: 500,
      crash_return_ms: 1000,
    },
  },
};
